...
namespace ELibrary_BookService.Application.Query
{
    public class BookReadProvider : IBookReadProvider
    {
        ...
        public async Task<BookReadModel> GetBook(int id)
        {
            ...
            string sql = @"SELECT ""Book"".""Id"", ""Book"".""BookAmount"", ""Book"".""CreatedDate"", ""Book"".""Description"", ""Book"".""ImageUrl"", ""Book"".""PdfUrl"", ""Book"".""Title"", ""Category"".""Id"", ""Category"".""Name"", ""Tag"".""Id"", ""Tag"".""Name"", ""Author"".""Id"", ""Author"".""Firstname"", ""Author"".""Lastname"", r.""Id"", r.""UserId"", r.""Like"", rev.""Id"", rev.""Content"", rev.""UserId"", u.""FirstName"", u.""LastName"", anu.""Email""
                    ...
                    left join ""userService"".""User"" u on u.""Id"" = rev.""UserId"" 
                    left join public.""AspNetUsers"" anu on anu.""Id"" = rev.""UserId""
                    WHERE ""Book"".""Id"" = @Id
";
            ...
            var result = books.GroupBy(bc => bc.BookReadModel.Id)
                .Select(g =>
                {
                    ...
                    book.Reviews = g.Select(ub => ub.ReviewReadModel).Where(x => x != null).GroupBy(x => x.ReviewId)
                        .Select(x => new ReviewReadModel(x.First().ReviewId, x.First().Content, x.First().UserId, x.First().FirstName, x.First().LastName, x.First().Email)).ToList();
