...
namespace ELibrary_BookService.Domain.Migrations
{
    ...
    [Migration("20230513092537_FixedTageTypo")]
    partial class FixedTageTypo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ELibrary_BookService.Domain.Entity.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ELibrary_BookService.Domain.Entity.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ELibrary_BookService.Domain.Entity.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ELibrary_BookService.Domain.Entity.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AuthorBook", b =>
                {
                    b.HasOne("ELibrary_BookService.Domain.Entity.Author", null)
                        .WithMany()
                        .HasForeignKey("AutorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ELibrary_BookService.Domain.Entity.Book", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BookCategory", b =>
                {
                    ...
                    b.HasOne("ELibrary_BookService.Domain.Entity.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BookTag", b =>
                {
                    ...
                    b.HasOne("ELibrary_BookService.Domain.Entity.Tag", null)
                        .WithMany()
